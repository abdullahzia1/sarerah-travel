  ...
  return (
    <form onSubmit={handleSubmit} className="mt-4 max-w-md space-y-3">
      ...
      <input
        ...
        className="w-full rounded-lg border border-stone-300 px-4 py-2 text-stone-900"
      />
      <input
        type="tel"
        name="phone"
      ...
      <button
        ...
        className="rounded-full bg-teal-600 px-5 py-2.5 font-semibold text-white hover:bg-teal-700 disabled:opacity-70"
      >
